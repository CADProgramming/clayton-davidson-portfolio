...
@section ('content')
    <div class="main-container">
            <div class="sub-container">
                <h1>Week 1: 20th - 24th of July</h1>
                <div >
                    <section class="during-class">
                        <h2>During Class Work</h2>
                        <div class="session-divider">
                            <h2 class="section-header">Class 1 (21st of July)</h2>
                            <div >This class was an introduction to software engineering and involved a group challenge which helped decide our team members.</div>
                            <h2 >Reflection</h2>
                            <h3 >What did you do in the last 30 minutes?</h3>
                            <div >
                                - Looked for a more inspirational team name (Piet)<img  src="./img/week-1/piet.jpg" alt="" style="width: 50px; padding-left: 25px; vertical-align:middle;">
                                <br><br>
                                ...
                                <br><br>
                                - Started looking at Laravel tutorials<img  src="./img/week-1/laravel.png" alt="" style="width: 140px; padding-left: 25px; vertical-align:middle;"><img  src="./img/week-1/laragon.png" alt="" style="width: 120px; padding-left: 25px; vertical-align:middle;">
                                <br><br>
                            ...
                            <h3 >What did you learn from this session?</h3>
                            <div >
                                ...
                                <br><br>
                                - Learning about effective ways to produce software in the real world industry<br><br><img  src="./img/week-1/research-pt1.jpg" alt="" style="width: 500px;"><img  src="./img/week-1/research-pt2.jpg" alt="" style="width: 500px;">
                                <br><br>
                                ...
                                <br><br>
                                - Basic background into laravel and how it communicates with servers to retrieve web applications<br><br><img  src="./img/week-1/mvc-understanding.jpg" alt="" style="width: 500px;">
                                <br><br>
                            ...
                            <h3 >How Does This Relate Back to the 12 Principles?</h3>
                            <div >
                        ...
                        <div class="session-divider">
                            <h2 class="section-header">Class 2 (24th of July)</h2>
                            <h3 >What did you do during this class?</h3>
                            <div >
                                - Set up the repository<br><br><img  src="./img/week-1/github-setup.png" alt="" style="width: 900px;"><img  src="./img/week-1/project-setup.png" alt="" style="height: 250px;">
                                <br><br>
                                ...
                                <br><br>
                                - Made progress through the Laracsts tutorials<br><br><img  src="./img/week-1/database-creation.png" alt="" style="height: 550px;">
                                <br><br>
                ...
                <section class="outside-class">
                    ...
                    <div class="session-divider">
                        <h2 class="section-header">22nd of July</h2>
                        <h3 >What work have you been doing outside of class?</h3>
                        <div>
                            - Progressing through the Laracasts tutorial that are on the moodle<br><br><img  src="./img/week-1/route-setup.PNG" alt="" style="height: 550px;"><img  src="./img/week-1/controller-setup.PNG" alt="" style="height: 550px;">
                            <br><br>
